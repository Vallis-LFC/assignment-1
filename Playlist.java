...
public class Playlist
{
	...
	{
		if (index < 1 || index > this.contents.size()) //checks if the content is inside the list
		{
	...
	{
		Playlist otherList = (Playlist) other;
		if(otherList.getTitle().equals(this.getTitle())) {
			return true;
		}
		return false;
	}
